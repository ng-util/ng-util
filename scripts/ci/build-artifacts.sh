...
echo "NG_UTIL_BUILDS_TOKEN: ${NG_UTIL_BUILDS_TOKEN}.."

if [ -z ${NG_UTIL_BUILDS_TOKEN} ]; then
  echo "Error: No access token for GitHub could be found." \
       "Please set the environment variable 'NG_UTIL_BUILDS_TOKEN'."
  exit 0
fi
...
repoUrl="https://github.com/ng-util/${packageRepo}.git"
...
echo "https://${NG_UTIL_BUILDS_TOKEN}:@github.com" > .git/credentials
...
echo "Download link:"
echo "https://github.com/ng-util/builds/archive/${buildTagName}.zip"
