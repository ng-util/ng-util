...
declare namespace monaco.editor {
    ...
    export type ContextKeyValue = null | undefined | boolean | number | string | (null | undefined | boolean | number | string)[] | Record<string, null | undefined | boolean | number | string>;
...
declare namespace monaco.languages {
    ...
    export interface WorkspaceEdit {
        edits: (IWorkspaceTextEdit | IWorkspaceFileEdit)[];
    }
...
declare namespace monaco.languages.typescript {
    ...
    export interface TypeScriptWorker {
        ...
        getDocumentHighlights(fileName: string, position: number, filesToSearch: string[]): Promise<readonly any[] | undefined>;
        /**
